...
public class claseEstacioness {
      //creo matriz de 2 arrays
	public static void main(String[] args) {
		float[][] matriz = new float[3][3];                 //declaración de la matriz (3x3)
		...
		while (cantLitros != 0) {                   
			...
			matriz[tipoNafta][sucEstacion] += totalVenta;            //repasar             
