 ...
 * 
 */
public class SumaTotalConstructor {
	private int valor1;
	...
	public SumaTotalConstructor() { // Agrego un metodo constructor (va a ser ejecutado llamado por el main)
	...
	public static void main(String[] args) {
		SumaTotalConstructor ejer = new SumaTotalConstructor(); // instancio la clase con un obj ejer
